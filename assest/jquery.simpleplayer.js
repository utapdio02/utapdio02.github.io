...
(function($) {
    $.fn.player = function(settings) {
        var config = {
            ...
            progressbarColor: '#119ea3',
            progressbarBGColor: '#e4eef2',
            defaultVolume: 0.8
        };
        ...
        this.each(function() {
            $(this).before('<div class="simple-player-container" style="background-color: #c3c3c3; padding: 0 10px 5px 5px;">');
            $(this).after('</div>');
            $(this).parent().find('.simple-player-container').prepend(
                '<div><ul>' + 
                    '<li style="display: inline-block; padding: 0 5px 0 2px; "><a style="text-decoration: none;"' +
